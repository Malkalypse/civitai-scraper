 ...
 * @return mixed Resulting filename or null if not found
 */
 ...
 * @param mixed $files Files array from model version data
 * @return mixed Resulting file or null if not found
 */
...
/** Normalize filename candidate by trimming, removing dangerous characters, and filtering out invalid names
