...
/** Convert Civitai image URL to thumbnail URL with specified transforms
 * - Handles both primary and legacy CDN formats
 * @param mixed $url				URL value
 * @param mixed $transform	Transform value
 ...
 * @param mixed $url URL value
 * @return mixed Image ID as integer, or null if not found
 */
 ...
 * @param mixed $imageId	imageId value
 * @param mixed $cacheDir	cacheDir value
